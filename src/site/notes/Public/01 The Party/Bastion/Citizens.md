---
{"dg-publish":true,"dg-path":"01 The Party/Bastion/Citizens.md","permalink":"/01-the-party/bastion/citizens/","dg-note-properties":{}}
---
...
> ![attachments/milo_coppershine.png](/img/user/Public/01%20The%20Party/Bastion/attachments/milo_coppershine.png)
> Milo Coppershine

> [!kith|no-bg c-orange no-i] ***General Merchant/Town Treasurer***  
...
> ![attachments/scrubbs.png](/img/user/Public/01%20The%20Party/Bastion/attachments/scrubbs.png)
> Sparrow (left) and Wren (right) Scrubb

> [!kith|no-bg c-red no-i] ***Milo's "Apprentices"***  
...
> [!kith|no-bg c-purple no-i] ***Tavernkeep***  
...
## Dorp and Dork
> [!caption|left wsmall static clear]
> ![attachments/trolls.png](/img/user/Public/01%20The%20Party/Bastion/attachments/trolls.png)
> Dorp and Dork

> [!kith|no-bg c-green no-i] ***Town Guards / Road Maintenance***  
